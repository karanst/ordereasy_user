...
class _SellerProfileState extends State<SellerProfile>
  ...
  Widget build(BuildContext context) {
    print("checking data here now   and ${widget.sellerData.username}");
    return Scaffold(
      appBar: AppBar(
        ...
        title:
        //widget.search?
        Text("${widget.sellerData.username}" , style: TextStyle(color: colors.primary),)
        //     :
                ...
                child: Column(children: [
                  ListTile(
                    leading: CircleAvatar(
                      backgroundImage: NetworkImage(widget.sellerData.logo.toString()),
                    ),
                    title: Text("${widget.sellerData.username}".toUpperCase()),
                    subtitle: Text(
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                          image: NetworkImage(widget.sellerData.logo),
                          fit: BoxFit.fill
                        )
                      ),
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            ListTile(
                              leading: CircleAvatar(
                                backgroundImage: NetworkImage(widget.sellerData.logo),
                              ),
                              title: Text("${widget.sellerData.username}".toUpperCase(),
                                style: TextStyle(
