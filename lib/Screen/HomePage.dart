...
import 'package:eshop_multivendor/Screen/ScannerPage.dart';
...
class _HomePageState extends State<HomePage>
  ...
  Future<void> getCurrentLoc() async {
    ...
    if (mounted) {
      setState(() {
        ...
        print("new current address here ${currentAddress.text}");
        latitude = position.latitude.toString();
        longitude = position.longitude.toString();
  ...
  deleteRecent(String id)async{
    var headers = {
      'Cookie': 'ci_session=85b3906c1dd7f97b39f2fa32eecb20750a5f6c0e'
    };
    var request = http.MultipartRequest('POST', Uri.parse('${baseUrl}recent_search_delete'));
    ...
    if (response.statusCode == 200) {
      ...
      var snackBar = SnackBar(
        content: Text('${jsonResult['message']}'),
      );
  ...
  getRecentSearch()async{
    ...
    var request = http.MultipartRequest('POST', Uri.parse('${baseUrl}recent_search'));
    request.fields.addAll({
      'user_id': '${CUR_USERID}'
    });
    request.headers.addAll(headers);
    ...
    if (response.statusCode == 200) {
      var finalResult = await response.stream.bytesToString();
      final jsonResponse = RecentSearchModel.fromJson(json.decode(finalResult));
      setState(() {
        recentSearchModel = jsonResponse;
      });
    }
    else {
      print(response.reasonPhrase);
                  ...
                  //  _catList(),
                   ...
                   // _seller()
                    Align(
                      ...
                      child: InkWell(
                        onTap: ()async{
                        var result =  await Navigator.push(context, MaterialPageRoute(builder: (context) => ScannerPage(title: "")));
                        if(result == true){
                          setState(() {
                          });
                          getRecentSearch();
                        ...
                        child: Container(
                          ...
                          alignment: Alignment.center,
                          child: Text("${getTranslated(context, 'ScanQrCode')}",style: TextStyle(color: Colors.white,fontSize: 15,fontWeight: FontWeight.w600),),
                        ),
                      ),
                    ),
                    _bakeries(),
      ...
      onTap: () async {
        ...
        if (data.isNotEmpty) {
          ...
          setState(() {
            ...
            loc.lat = data[1];
            loc.lng = data[2];
            print("address here ${currentAddress.text}");
            sellerList.clear();
            print(longitude);
       //     getSeller();
            getRecentSearch();
  ...
  _bakeries() {
        return recentSearchModel == null ? Center(child: CircularProgressIndicator(color: colors.primary,),) : recentSearchModel!.date == null ? SizedBox() : Padding(
          ...
          child: Container(
            child: Column(
              ...
              children: [
                ListTile(
                  title: Text(getTranslated(context, 'RecentSeller')!,
                      style: TextStyle(
                          color: Theme.of(context).colorScheme.fontColor,
                          fontWeight: FontWeight.bold)),
                  // trailing: TextButton(
                ...
                ListView.builder(
                  itemCount: recentSearchModel!.date!.length,
                      ...
                      child: GestureDetector(
                        onTap: () {
                          ...
                          //   print("working here");
                            ...
                            //     MaterialPageRoute(
                            //         builder: (context) => SubCategory(
                            //           title: recentSearchModel!.date![index]
                            //               .username
                            //               .toString(),
                            //           sellerId: recentSearchModel!.date![index]
                            //               .userId
                            //               .toString(),
                                      ...
                                      child: Column(
                                        children: [
                                          ListTile(
                                            dense: true,
                                            title: Text(
                                              "${recentSearchModel!.date![index].username!}",
                                              style: Theme.of(
                                                  context)
                                            ...
                                            subtitle: Text(
                                              "${recentSearchModel!.date![index].address!}",
                                              maxLines: 2,
                                              style: Theme.of(
                                                  context)
                                                  .textTheme
                                            ...
                                            trailing: Column(
                                              ...
                                              children: [
                                                InkWell(
                                                    onTap:(){
                                                     deleteRecent(recentSearchModel!.date![index].qrNumber.toString());
                                                    },
                                                    child: Padding(
                                                ...
                                                FittedBox(
                                                  child: Row(
                                                    children: [
                                                      ...
                                                      Text(
                                                        "${recentSearchModel!.date![index].rating!}",
                                                        style: Theme.of(
                                                            context)
                                                            .textTheme
                                                            .caption!
                                                      ...
                                                      child: Center(
                                                        child: Padding(
                                                          padding: const EdgeInsets
                                                              ...
                                                              2),
                                                          child: Text(
                                                            "${recentSearchModel!.date![index].estimatedTime}",
                                                            style: TextStyle(
                                                                fontSize:
                                                                14),
                                                          ),
                                                  ...
                                                  child: Container(
                                                      ...
                                                      Padding(
                                                        padding: const EdgeInsets
                                                            ...
                                                            1),
                                                        child: Text(
                                                          "${recentSearchModel!.date![index].foodPerson}",
                                                          style: TextStyle(
                                                              fontSize:
                                                              14),
                                                        ),
